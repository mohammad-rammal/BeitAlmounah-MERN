      ...
      <div className='w-full px-4 lg:px-20 pt-5'>
        ...
        <div className='flex gap-10 items-center justify-center px-4'>
          <div className='flex flex-col justify-between'>
            ...
            <p className='text-neutral-800 text-[12px] md:text-md'>CALORIES</p>
          </div>
          ...
          <div className='flex flex-col justify-center'>
            ...
            <p className='text-neutral-800 text-[12px] md:text-md'>
              TOTAL TIME
            </p>
          </div>
          ...
          <div className='flex flex-col justify-center'>
            ...
            <p className='text-neutral-800 text-[12px] md:text-md'>SERVINGS</p>
          </div>
        ...
        <div className='w-full flex flex-col md:flex-row gap-8 py-20 pxx-4 md:px-10'>
          ...
          {/* Right SIDE */}
          <div className='w-full md:w-2/4 md:border-l border-slate-800 pl-1'>
            <div className='flex flex-col gap-5 px-10'>
              <p className='text-green-500 text-2xl underline px-10'>Ingredients</p>

              {
                recipe?.ingredientLines?.map((ingredient, index) => {
                  return (
                    <p key={index} className='text-neutral-800 flex gap-2'>
                      <AiFillPushpin className='text-blue-400 text-xl' /> {ingredient}
                    </p>
                  )
                })
              }
            ...
            <div className='flex flex-col gap-3 mt-20 px-10'>
              <p className='text-green-700 text-2xl underline px-5'>Health Labels</p>
